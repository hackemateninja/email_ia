...
#
#     PHX_SERVER=true bin/email_ia start
#
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/email_ia/email_ia.db
      """
  ...
  config :email_ia, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :email_ia, EmailIa.Mailer,
